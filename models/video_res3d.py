...
def r3d(pretrained=False, progress=True):
    """Get R3D_18 models."""
    return r3d_18_rgb(pretrained=pretrained, progress=progress)


def mc3(pretrained=False, progress=True):
    return mc3_18_rgb(pretrained=pretrained, progress=progress)


def r2plus1d(pretrained=False, progress=True):
    """Get R2PLUS1D_18 models."""
    return r2plus1d_18_rgb(pretrained=pretrained, progress=progress)
